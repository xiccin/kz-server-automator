...
apt-get install libstdc++6:i386 libgcc1:i386 libc6:i386 libstdc++6:i386 zlib1g:i386 libcurl4:i386 libncurses5:i386 libstdc++6 libgcc1 libc6 libstdc++6 zlib1g libcurl4 libncurses5 -y &>>/root/scripts/logs/setup.log
